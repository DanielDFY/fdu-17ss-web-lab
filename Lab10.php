    ...
    <main class="container">
		...
		<ul class="caption-style-2">
            ...
            */
            ...
            if(isset($_GET["continent"]) AND isset($_GET["country"]) AND isset($_GET["title"])){
                $continent = htmlspecialchars($_GET['continent']);
                $country = htmlspecialchars($_GET['country']);
                if($continent AND !$country)$sql=findByContinent($continent);
                else if(!$continent AND $country)$sql=findByCountry($country);
                else if($continent AND $country)$sql=findByContinentAndCountry($continent,$country);
            ...
            if($result){
                while($row = $result->fetch_assoc()) {
                    echo '<li><a href="detail.php?id='.$row['ImageID'].'" class="img-responsive"><img src="images/square-medium/'.$row['Path'].'" alt="'.$row['Title'].'><div class="caption"><div class="blur"></div><div class="caption-text"><p>'.$row['Title'].'</p></div></div></a></li> ';
                }
            }
