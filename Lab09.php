...
<body>
   ...
   //              </a>
          ...
          foreach($images as $x){
              echo "<li><a href='detail.php?id=".$x['id']."' class='img-responsive'>";
              echo "<img src='images/square/".$x['path']."' alt='".$x['title']."'>";
              echo "<div class='caption'><div class='blur'></div>";
              echo "<div class='caption-text'><h1>".$x['title']."</h1></div></div></a></li>";
          }
          ?>
